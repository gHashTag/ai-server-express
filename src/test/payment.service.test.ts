...
describe('PaymentService', () => {
  ...
  it('should process payment and increment balance for 1999', async () => {
    ...
    expect(sendPaymentNotification).toHaveBeenCalledWith(1999, 1249, '123456', 'en', 'testuser');
  });
  ...
  it('should process payment and increment balance for 5000', async () => {
    ...
    expect(sendPaymentNotification).toHaveBeenCalledWith(5000, 3040, '123456', 'en', 'testuser');
  });
