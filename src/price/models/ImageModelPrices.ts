...
export const imageModelPrices: Record<string, ModelInfo> = {
  ...
  'black-forest-labs/flux-canny-dev': {
    ...
    previewImage: 'https://replicate.delivery/xezq/4bt5HoegzYR9EKqv70zsBoHnhFkcaB9Yk1naaQJai6rtfPzTA/out-0.webp',
  ...
  'black-forest-labs/flux-canny-pro': {
    ...
    previewImage: 'https://replicate.delivery/czjl/yRS3V6IYC877GF3DnejR0WJvcz5eg6LTlbE3cJPC6CJQqMzTA/tmp8gs0wfw3.jpg',
  ...
  'black-forest-labs/flux-dev': {
    ...
    previewImage: 'https://replicate.delivery/yhqm/xU3wLlAQcGpZLVQipTVxaZMaL4omk9n7d1suU0byMnngfQvJA/out-0.webp',
    costPerImage: calculateFinalImageCostInStars(0.025),
    inputType: ['text', 'image'],
  },
  'black-forest-labs/flux-dev-lora': {
    ...
    previewImage: 'https://replicate.delivery/xezq/a43wloJrIDpoJpCH81EfhI00PbQrmhpfpUWqCvZPtWEsOvwTA/out-0.webp',
  ...
  'black-forest-labs/flux-pro': {
    ...
    previewImage: 'https://bflapistorage.blob.core.windows.net/public/c8145aa6e5894cbd815d6ce708fea9f2/sample.jpg',
  ...
  'ideogram-ai/ideogram-v2': {
    ...
    previewImage: 'https://replicate.delivery/czjl/wPuHfFHPOGxqbC3r1rJbEomny4eprgwRVpjIP7pN7oKf6pSnA/R8_ideogram.png',
  ...
  'ideogram-ai/ideogram-v2-turbo': {
    ...
    previewImage: 'https://replicate.delivery/czjl/9aabtkgKeV2HS6bASFV9uEvkufPMZlE2MelytHKnUs4yeTlOB/R8_ideogram.png',
    costPerImage: calculateFinalImageCostInStars(0.05),
    inputType: ['text', 'image'],
  },
  'luma/photon': {
  ...
  'recraft-ai/recraft-20b': {
    ...
    previewImage: 'https://replicate.delivery/czjl/ktMwWoliJ6K2Bx8IVQO0xAEujmdERpkAdid7ZAHCbFZqoieJA/tmpe5t63bfy.webp',
  ...
  'recraft-ai/recraft-v3': {
    ...
    previewImage: 'https://replicate.delivery/czjl/eTxDZunLeFulD0734CMCIuhP6llmZbgtbxfjzyfi4hxAAOwOB/output.webp',
    costPerImage: calculateFinalImageCostInStars(0.04),
    inputType: ['text'],
  },
  ...
  'stability-ai/stable-diffusion-3': {
    ...
    previewImage: 'https://replicate.delivery/yhqm/i4mS31BVDBYVIF0ol6UV2dwHwuztMDbsnlVJBeJ75ViVTQhJA/R8_SD3_00001_.webp',
  ...
  'stability-ai/stable-diffusion-3.5-large': {
    ...
    previewImage: 'https://replicate.delivery/yhqm/x5swvMgXyDr5JxhAqWf7Sty3YdzweRHHgG6EZA5ndfN0WwSnA/R8_sd3.5L_00001_.webp',
  ...
  'stability-ai/stable-diffusion-3.5-large-turbo': {
    ...
    previewImage: 'https://replicate.delivery/yhqm/qPajhUQ3G3qLAtsMA1MMH7z7Z7kwLKy7WsIOgf0ijcjNpr0JA/R8_sd3.5L_00001_.webp',
    costPerImage: calculateFinalImageCostInStars(0.04),
    inputType: ['text', 'image'],
  },
  'stability-ai/stable-diffusion-3.5-medium': {
    ...
    previewImage: 'https://replicate.delivery/yhqm/b8ZWW3KneUSuca1q7wzUrSpRsElbIdLtFqXEMaZetgrLaprTA/R8_sd3.5L_00001_.webp',
    costPerImage: calculateFinalImageCostInStars(0.035),
    inputType: ['text', 'image'],
  },
};
